...
include 'baglan.php';
  ...
  $benzerilan=$db->prepare("SELECT * FROM kiralikevilani WHERE ilID=$ilID OR ilceID=$ilceID LIMIT 4");
...
$ilID=$ilansonuc['ilID'];
    ...
    $benzerilan_id=$ilansonuc['kilanID']; if($simdikiilan == $benzerilan_id){continue;}
